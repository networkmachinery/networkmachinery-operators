...
import (
	...
	"github.com/networkmachinery/networkmachinery-operators/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*NetworkmachineryV1alpha1Client, error) {
	config := *c
	...
	return &NetworkmachineryV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworkmachineryV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *NetworkmachineryV1alpha1Client {
...
// New creates a new NetworkmachineryV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *NetworkmachineryV1alpha1Client {
	return &NetworkmachineryV1alpha1Client{c}
}
...
func (c *NetworkmachineryV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
